---
title: EmailField
description: Email input with v-model support. Wraps the Polaris <s-email-field> web component.
---
...
Renders as `<s-email-field>`. See [Polaris EmailField docs](https://shopify.dev/docs/api/app-home/web-components/forms/email-field).
