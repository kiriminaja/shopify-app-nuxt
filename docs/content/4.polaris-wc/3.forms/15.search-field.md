---
title: SearchField
description: Search input with v-model support. Wraps the Polaris <s-search-field> web component.
---
...
<template>
  <ShSearchField v-model="query" label="Search products" placeholder="Search…" />
</template>
```
...
Renders as `<s-search-field>`. See [Polaris SearchField docs](https://shopify.dev/docs/api/app-home/web-components/forms/search-field).
