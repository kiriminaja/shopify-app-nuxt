---
title: UrlField
description: URL input with v-model support. Wraps the Polaris <s-url-field> web component.
---
...
<template>
  <ShUrlField v-model="url" label="Website URL" placeholder="https://example.com" />
</template>
```
...
Renders as `<s-url-field>`. See [Polaris UrlField docs](https://shopify.dev/docs/api/app-home/web-components/forms/url-field).
