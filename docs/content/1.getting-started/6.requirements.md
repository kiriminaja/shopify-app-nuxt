---
title: Requirements
description: Prerequisites for building a Shopify app with shopify-nuxt.
navigation:
  icon: i-lucide-clipboard-check
seo:
  title: Requirements — shopify-nuxt
  description: What you need before building a Shopify app with shopify-nuxt — accounts, tools, and environment setup.
---

## Prerequisites

Before you start building with `shopify-nuxt`, make sure you have the following:
...
`shopify-nuxt` depends on these packages (installed automatically):
...
| `@shopify/storefront-api-client`              | Typed Storefront API client                       |
