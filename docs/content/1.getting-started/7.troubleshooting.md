...
description: Common issues and solutions when building Shopify apps with shopify-app-nuxt.
seo:
  description: Troubleshooting guide for common shopify-app-nuxt issues — OAuth errors, App Bridge, session storage, and more.
---
