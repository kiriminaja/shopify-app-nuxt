---
title: Installation
description: Install and configure shopify-nuxt in your Nuxt application.
navigation:
  icon: i-lucide-download
seo:
  description: Install shopify-nuxt and configure it to build Shopify apps with Nuxt 4.
  title: Installation
---
...
Add `shopify-nuxt` to your Nuxt application:
...
Add `shopify-nuxt` to the `modules` section and configure your Shopify credentials:
