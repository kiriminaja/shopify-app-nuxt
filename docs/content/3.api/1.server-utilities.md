...
seo:
  title: Server Utilities — shopify-nuxt API Reference
  description: Complete reference for all shopify-nuxt server utilities — auto-imported functions and #shopify/server exports.
---
...
The module exports test helpers through `shopify-nuxt/test-helpers`:
