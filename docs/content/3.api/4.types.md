---
title: Types
description: Key TypeScript types and interfaces exported by shopify-nuxt.
navigation:
  icon: i-lucide-braces
seo:
  title: Types — shopify-nuxt API Reference
  description: Complete TypeScript type reference for shopify-nuxt — ModuleOptions, AdminContext, WebhookContext, BillingContext, and more.
---
