...
description: Authenticate admin requests, handle OAuth, and manage sessions in shopify-nuxt.
navigation:
  icon: i-lucide-shield-check
seo:
  title: Authentication — shopify-nuxt
  description: Learn how to authenticate admin requests, handle OAuth flows, and manage per-merchant sessions with shopify-nuxt.
---
